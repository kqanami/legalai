  ...
  return (
    <div className="bg-obsidian-950 overflow-hidden">
      ...
      <div className="h-[150vh] w-full relative z-0">
        <div className="sticky top-0 h-[100svh] w-full flex flex-col items-center justify-center overflow-hidden bg-obsidian-950">
          {/* Backgrounds */}
      ...
      <div className="relative z-10 bg-obsidian-950 rounded-t-[3rem] shadow-[0_-30px_80px_rgba(0,0,0,0.9)] overflow-hidden -mt-[50vh]">

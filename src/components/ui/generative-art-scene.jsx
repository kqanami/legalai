  ...
  useEffect(() => {
    ...
    const material = new THREE.ShaderMaterial({
      uniforms: {
        ...
        color: { value: new THREE.Color(0xd4d4d8) }, // neutral-300 / silver
      },
      vertexShader: `
                uniform float time;
    ...
    const handleMouseMove = (e) => {
      // Need bounds relative to container rather than full window for accuracy
    ...
    // Bind to the container or window. Window feels more global.
